...
local Window = Fluent:CreateWindow({
    Title = "Sang Hub (Kaitan)",
    SubTitle = "- join my discord server : https://discord.com/invite/NP2AsFEm",
    TabWidth = 145,
...
print("made by Sang hay lứng")
    print("Sang hub")
    print("join my discord server : https://dsc.gg/m1m")
    print("boing boing")
    print("ty for using - have fun")
    print("sk (on discord : @sang0358 or @sangmoithucdaynek)")
    print("wait ,.,")
    print("LCTSV - .,.")  
